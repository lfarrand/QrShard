...
decode. **Take the current release (1.5.2)** if you decode images from anywhere you do not
...
recommendation — fixes go to the latest release only, so take the current one (1.5.2):
